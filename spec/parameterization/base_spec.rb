...
describe Fyber::Parameterization::Base do
  ...
  describe '#generate' do
    ...
    let(:result_string) { 'appid=157&device_id=2b6f0cc904d137be2e1730235f5664094b83&ip=109.235.143.113&locale=de&offer_types=112&page=6&ps_time=1312211903&pub0=my_campaign&timestamp=1312553361&uid=efreesen&hashkey=7a2b1604c03d46eec1ecd4a686787b75dd693c4d' }
